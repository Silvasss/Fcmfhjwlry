...
export default function Profile({ nomeUsuario }) {
                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      ...
                      <Grid item>
                        <Tooltip title="Logout">
                          <IconButton size="large" sx={{ color: 'text.primary' }} onClick={() => { store.dispatch(logoutUser()) }} href='/'>
                            <LogoutOutlined />
                          </IconButton>
                        </Tooltip>
                      </Grid>
...
Profile.propTypes = { nomeUsuario: PropTypes.string }