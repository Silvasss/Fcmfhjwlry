...
export default function Edit({ id, handleClose, open, updateDados, user, endpoints }) {
    ...
    const handleSubmit = async () => {
        try {
            await endpoints.customFetch.put(`/admin/usuario/${dados.usuario_Id}&${regra}`, regra, { headers: { Authorization: `Bearer ${user.token}` } })
    ...
    return (
        <Dialog
            ...
            fullWidth={true}
        >
            <DialogTitle>Alterar regra usuário</DialogTitle>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        <Stack spacing={1}>
                            <DialogContentText id="alert-dialog-description">
                                Você está alterando a regra do seguinte usuário:
                            </DialogContentText>
                        </Stack>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        <Stack spacing={1} mt={1}>
                            <InputLabel htmlFor="privilegio" style={{ color: "text.secondary", fontSize: "0.875rem", lineHeight: 1.43, fontWeight: 400, variant: 'caption' }}>Privilégio</InputLabel>

                            <Select
                                name="privilegio"
                                labelId="demo-simple-select-privilegio"
                                id="privilegio"
                                value={regra}
                                label="privilegio"
            ...
            <DialogActions disableSpacing sx={{ m: 1 }}>
                <Stack display={"flex"} flexDirection={"row"} justifyContent={"flex-end"} alignItems={"center"}>
                    ...
                    <Button variant="contained" color='warning' sx={{ ml: '16px' }} onClick={() => handleSubmit()}>Alterar</Button>
                </Stack>
            </DialogActions>
        </Dialog >
    )
...
Edit.propTypes = { id: PropTypes.number, handleClose: PropTypes.func, open: PropTypes.bool, updateDados: PropTypes.func, user: PropTypes.any, endpoints: PropTypes.any };
